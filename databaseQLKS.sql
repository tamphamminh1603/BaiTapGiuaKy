...
go
insert into datphong values('DP001','NV002','KH001','Superio',getdate(),convert(date,'08/01/2015',105),convert(date,'08/02/2015',105),100000,2,0,'HD001')
insert into datphong values('DP002','NV002','KH002','Standard',getdate(),convert(date,'01/03/2015',105),convert(date,'10/03/2015',105),60000,3,0,'HD002')
insert into datphong values('DP003','NV003','KH003','Deluxe',getdate(),convert(date,'04/05/2015',105),convert(date,'12/05/2015',105),60000,2,0,'HD003')
insert into datphong values('DP004','NV003','KH004','Deluxe',getdate(),convert(date,'08/01/2015',105),convert(date,'08/02/2015',105),60000,2,0,'HD004')
insert into datphong values('DP005','NV002','KH005','Suite',getdate(),convert(date,'25/12/2014',105),convert(date,'28/12/2014',105),80000,2,1,'HD005')
...
insert into hoadon values('HD005','DP001',getdate(),2400000)
